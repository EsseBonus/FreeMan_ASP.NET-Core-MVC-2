...
namespace ModelValidation.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ViewResult MakeBooking(Appointment appt)
        {
            ...
            //{
            //    ModelState.AddModelError(nameof(appt.ClientName), $"Please enter your name (form {nameof(HomeController)})");
            //}

            //if (ModelState.GetValidationState("Date") == ModelValidationState.Valid && DateTime.Now > appt.Date)
            //{
            //    ModelState.AddModelError(nameof(appt.Date), $"Please enter a date in the future (form {nameof(HomeController)})");
            //}
            ...
            //{
            //    ModelState.AddModelError(nameof(appt.TermsAccepted), $"You must accept the terms (form {nameof(HomeController)})");
            //}
