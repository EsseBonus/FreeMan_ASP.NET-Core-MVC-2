...
namespace SportsStore.Tests
{
    public class AdminControllerTests
    {
        ...
        public void Can_Save_Valid_Changes()
        {
            ...
            mock.Verify(iProductRepository => iProductRepository.SaveProduct(product));
        ...
        public void Cannot_Save_Invalid_Changes()
        {
            ...
            mock.Verify(iProductRepository => 
                iProductRepository.SaveProduct(It.IsAny<Product>()), Times.Never());
